...
const benefits = [
  ...
  { icon: "◆", purple: true, title: "PRIME限定イベントへの招待", desc: "著名シェフ・生産者を招いた非公開ディナー、プライベートセラー見学など、PRIME会員のみが参加できる特別なイベントに招待されます。" },
  { icon: "◆", purple: true, title: "提携店舗 最大30%OFF", desc: "通常会員10〜20%OFFに対し、PRIMEは最大30%OFFで利用可能。La Cave、Coffee Commonsなど全提携店舗が対象。" },
  ...
  { icon: "◆", purple: true, title: "会員証のゴールドPRIMEデザイン", desc: "特別デザインのPRIMEゴールド会員証が発行されます。提携店舗では最上級の対応を受けられます。" },
];
    ...
    return (
      <div className="flex justify-center bg-[var(--color-bg)] min-h-screen">
        <div className="w-full max-w-[430px] flex flex-col items-center justify-center px-8 py-20 text-center">
          ...
          <h1 className="font-display text-2xl mb-2">PRIMEプランへようこそ</h1>
          <p className="text-sm text-[var(--color-mute)] leading-relaxed mb-8">
            アップグレードが完了しました。<br />次回のPRIME限定イベントのご案内をお楽しみに。
          </p>
    ...
    <div className="flex justify-center bg-[var(--color-bg)] min-h-screen">
      <div className="w-full max-w-[430px] pb-24">
        ...
        <div className="px-5 py-8 space-y-5 border-b border-[var(--color-line)]">
          <h2 className="font-display text-lg mb-4">PRIME特典</h2>
          {benefits.map((b, i) => (
        ...
        <div className="px-5 py-8 space-y-3">
          ...
          <p className="text-[10px] text-[var(--color-mute)] text-center leading-relaxed">
            決済ボタンを押すことで、PRIMEプラン利用規約に同意したものとみなされます。
          </p>
        </div>
      </div>
    </div>
