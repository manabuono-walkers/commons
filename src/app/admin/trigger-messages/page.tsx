  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
        <div className={`w-full md:w-[360px] border-r border-[var(--color-line)] overflow-y-auto flex-none ${selectedId ? "hidden md:block" : ""}`}>
          {TRIGGERS.map(t => (
            <div key={t}>
        ...
        <div className={`flex-1 overflow-y-auto px-4 md:px-8 py-6 ${selectedId ? "" : "hidden md:block"}`}>
          {selected ? (
            <div className="max-w-[600px]">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-start justify-between gap-3 mb-5">
                <div>
