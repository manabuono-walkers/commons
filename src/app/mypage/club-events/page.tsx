...
const events = [
  { id: "wine-club-0720",  month: "7月", day: "20", weekday: "日", name: "ワインクラブ 月例会",       venue: "La Cave · 麻布十番",    time: "19:00〜" },
  { id: "photo-club-0727", month: "7月", day: "27", weekday: "日", name: "フォトウォーク 谷中編",     venue: "谷中霊園 集合",          time: "10:00〜" },
  { id: "outdoor-0803",    month: "8月", day: "3",  weekday: "月", name: "アウトドアクラブ 奥多摩",  venue: "奥多摩駅 集合",          time: "08:00〜" },
];
    ...
    <div className="flex justify-center bg-[var(--color-bg)] min-h-screen">
      <div className="w-full max-w-[430px] pb-24">
        ...
        <main className="px-5 pt-6">
          <h1 className="font-display text-xl font-semibold mb-5">参加予定クラブ会イベント</h1>
          <div className="card p-4">
            {events.length === 0 ? (
              <p className="text-xs text-[var(--color-mute)]">参加予定のクラブ会イベントはありません。</p>
            ) : (
